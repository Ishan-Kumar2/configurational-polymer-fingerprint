...
class Input
{
  public:
    ...
    void ReadInput(int argc, char* argv[])
    {
	  ...
	  ("NBEAD,n", value<int>(&NBEAD)->default_value(100), "number of beads in the system (default 100)")
	  ("SWEEP,s", value<int>(&SWEEP)->default_value(10000000), "#MC sweeps (default 10000000)")
	  ("SAMPLE,S", value<int>(&SAMPLE)->default_value(100000), "Sampling Frequency (default 100000")
	  ("MCSTEP,m", value<double>(&MCSTEP)->default_value(3.85), "MC step (default 3.85)")
